...
function allRed(){
    ...
    setTimeout(() => {
        ...
        ball5.style.background = "#fff"
        ball1.style.background = "#fff"
        ball2.style.background = "#fff"
        ball3.style.background = "#fff"
        ball4.style.background = "#fff"

        ball5.style.backgroundImage = "linear-gradient(300deg, var(--color-neutral-2), var(--color-primary-4))"
        ball1.style.backgroundImage = "linear-gradient(45deg, var(--color-primary-6), var(--color-primary-2))"
        ball2.style.backgroundImage = "linear-gradient(45deg, var(--color-primary-6), var(--color-primary-4))"
        ball3.style.backgroundImage = "linear-gradient(90deg, var(--color-primary-3), var(--color-primary-2))"
        ball4.style.backgroundImage = "linear-gradient(300deg, #c43a08, var(--color-primary-4))"
